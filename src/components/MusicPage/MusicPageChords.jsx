    ...
    return (
        <div>
            ...
            <div className={`relative w-full h-full flex flex-col gap-2 justify-center items-center mb-10 ${props.editMode && 'z-30 brightness-150'}`}>
                <div onClick={props.handleEditClick} className="absolute top-0 right-0 md:translate-x-1/3 -translate-y-1/3 cursor-pointer bg-slate-600/30 p-2 rounded-full z-20">
